...
<div id = "main">
                ...
                <ul class="navbar-nav mr-auto"><!-- mr-auto is used to specify the right margin for the right margin (content is pushed as left as possible)-->
                    ...
                    <li class="nav-item dropdown">
	                    ...
	                    <div class="dropdown-menu">
	                       	<a href="all_blog_posts.php" class="dropdown-item active">Blog</a>
	...
	<div class = "home_page">
		...
		<div class = "main_page">
			...
			<?php
			$sql_query_posts = "SELECT Post_TEXT, Post_Description , Posting_date, Post_Title, Post_ID FROM posts WHERE Post_Type = 'blog' ORDER BY Posting_date DESC";
			if ($result = $mysqli->query($sql_query_posts)) {
				...
				$sql_limit_on_page='SELECT Post_TEXT, Post_Description , Posting_date, Post_Title, Post_ID FROM posts WHERE Post_Type = "blog" ORDER BY Posting_date DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
				...
				?>
					<div class = "media border p-3 d-none d-sm-none d-xl-block" style=" width: auto; height: 300px;">
						...
						<div class = "media-body">
							...
							<p class = "p_date"><?php echo "Posting Date : ".$row_on_page['Posting_date'] ?></p>
					...
					<div class="card d-block d-sm-block d-xl-none" style="width:auto">
							...
							?>
								<?php echo "<img class='card-img-top'  alt='Card image' style='width:150px' src='data:image/jpeg;base64," . base64_encode( $row_imag['Imagine'] ) . "'/>"; ?>
							<?php 
								}
								else{
							?>
								<?php echo "<img src='./placeholder.jpg' class='card-img-top'  alt='Card image' style='width:150px'/>"; ?>
							<?php
								}
							?>
					    <div class="card-body">
				...
				echo '<a href="all_blog_posts.php?inc=false&page=' .$page. '" class = "pages">Previous</a> ';
	    		//display links to pages
		    	if($page + $no_pages_links  <= $total_pages){
			    	for($pages = $page; $pages < $page + $no_pages_links ;$pages++){
			    			 echo '<a href="all_blog_posts.php?page=' . $pages . '" class = "pages">' . $pages. '</a> ';
			    	}
		    	}
		    	else{
	    		...
	    		echo '<a href="all_blog_posts.php?inc=true&page='. $page. '" class = "pages">Next</a> ';
