...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Sitka Subheading", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(24, 34);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(129, 35);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Sitka Subheading", 18));
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Sitka Small", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(159, 48);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Sitka Small", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(158, 122);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Sitka Subheading", 18));
			this->button1->Location = System::Drawing::Point(159, 148);
			...
			this->ClientSize = System::Drawing::Size(327, 222);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->textBox2);
			this->Controls->Add(this->textBox1);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->label1);
			this->MaximumSize = System::Drawing::Size(343, 261);
			this->MinimumSize = System::Drawing::Size(343, 261);
			this->Name = L"Login";
			this->Text = L"Sign in Student";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		SqlConnection^ conn = gcnew SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename=|DataDirectory|\\BazaDeDateProiect.mdf;Integrated Security=True;Connect Timeout=30");
			String^ query = "SELECT COUNT(*) FROM Studenti WHERE FirstName = '" + textBox1->Text + "'AND LastName = '" + textBox2->Text + "';";
			conn->Open();
			...
			if (count == 1){
				...
				//SqlConnection^ conn = gcnew SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename=C:\\Users\\Andrei\\Desktop\\PROIECT POO\\Proiect_ POO_v2\\Proiect POO\\BazaDeDateProiect.mdf;Integrated Security=True;Connect Timeout=30");
				conn->Open();
				SqlCommand^ getID = gcnew SqlCommand("SELECT ID FROM Studenti WHERE FirstName = '" + textBox1->Text + "'AND LastName = '" + textBox2->Text + "';", conn);
				int id = (int)getID->ExecuteScalar();

				Alegere_Materii^ materii = gcnew Alegere_Materii;
				materii->id_student = id;
				materii->Show(this);
			}
			else{
				this->Close();
				conn->Close();
				MessageBox::Show("There is no student user with this data. Please make an account first and then you will be able to enter the app!");
				Application::Exit();
			}
		}
	};
